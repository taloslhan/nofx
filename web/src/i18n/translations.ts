...
export const translations = {
  en: {
    ...
    scanIntervalRecommend:
      'Recommended: 3-10 minutes. Non-grid strategies will auto-align evaluation to candle close of the primary timeframe.',
    useTestnet: 'Use Testnet',
    enabled: 'Enabled',
    save: 'Save',
    testConnection: 'Test Connection',
    testSavedConnection: 'Test Availability',
    testSavedConnectionTooltip: 'Test if this AI model is reachable',
    ...
    strategyStudio: {
      ...
      reverseStrategy: 'Reverse Strategy',
  ...
  zh: {
    ...
    scanIntervalRecommend:
      '建议: 3-10分钟。非网格策略将自动按策略主周期K线收线时间触发评估。',
    useTestnet: '使用测试网',
    enabled: '启用',
    save: '保存',
    testConnection: '测试连接',
    testSavedConnection: '测试可用性',
    testSavedConnectionTooltip: '测试此 AI 模型是否可达',
  ...
  id: {
    ...
    scanIntervalRecommend:
      'Disarankan: 3-10 menit. Strategi non-grid akan otomatis menyelaraskan evaluasi ke penutupan candle timeframe utama.',
    useTestnet: 'Gunakan Testnet',
    enabled: 'Aktif',
    save: 'Simpan',
    testConnection: 'Uji Koneksi',
    testSavedConnection: 'Uji Ketersediaan',
    testSavedConnectionTooltip: 'Uji apakah model AI ini dapat dijangkau',
    testingConnection: 'Sedang menguji...',
    testSuccess: 'Koneksi berhasil',
    testFailed: 'Koneksi gagal',
    testLatency: 'Latensi: {ms} ms',
    ...
    strategyStudio: {
      ...
      reverseStrategy: 'Strategi Terbalik',
