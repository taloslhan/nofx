...
export const translations = {
  en: {
    ...
    scanIntervalRecommend: 'Recommended: 3-10 minutes. Non-grid strategies will auto-align evaluation to candle close of the primary timeframe.',
  ...
  zh: {
    ...
    scanIntervalRecommend: '建议: 3-10分钟。非网格策略将自动按策略主周期K线收线时间触发评估。',
    useTestnet: '使用测试网',
    enabled: '启用',
    save: '保存',
  ...
  id: {
    ...
    scanIntervalRecommend: 'Disarankan: 3-10 menit. Strategi non-grid akan otomatis menyelaraskan evaluasi ke penutupan candle timeframe utama.',
